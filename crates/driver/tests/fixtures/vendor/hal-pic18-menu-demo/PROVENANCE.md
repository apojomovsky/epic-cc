...
the menu-only `epic-lcd` module, this demo's copy of the
...
```
epic-lcd/include/epic_lcd.h
epic-lcd/include/epic_lcd_transport.h
epic-lcd/src/epic_lcd.c
epic-lcd/src/epic_lcd_gpio4.c
epic-menu-demo/include/menu_demo_core.h
