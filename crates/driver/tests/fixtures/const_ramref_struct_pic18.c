...
//! The volatile view is the runtime escape hatch: a volatile pointer can
//! hold anything at runtime, so neither clang nor the whole-program opt
//! may fold the deref chain, and the table bytes are really read.
#include <stdint.h>
