...
# cmake needs it); git/file are general tooling; gdb is the debugger
# acceptance oracle (crates/driver/tests/debug_session_e2e.rs runs it as a
# subprocess against epic-cc-gdbserver, epic-cc#259); csmith/creduce/cvise/
