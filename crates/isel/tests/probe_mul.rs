...
fn probe() {
    let cases = [
        (0x3DCC_CCCDu32, 0x3E4C_CCCDu32, "0.1 * 0.2"),
        (0x3C53_CE8B, 0x3C53_CE8B, "M15 low sum crosses 2^23"),
        (0x4040_0000, 0x3F00_0000, "3.0 * 0.5"),
        ...
        (0x0000_0001, 0x0000_0001, "minden * minden"),
        (0x007F_FFFF, 0x3F80_0000, "maxden * 1.0"),
        (0x007F_FFFF, 0x3F00_0000, "maxden * 0.5"),
        (0x007F_FFFF, 0x4040_0000, "maxden * 3.0"),
        (0x7F80_0000, 0x4000_0000, "inf * 2.0"),
        (0x7F80_0000, 0x0000_0000, "inf * 0.0"),
        (0x7FC0_0000, 0x4000_0000, "nan * 2.0"),
        (0x3F80_0000, 0x3F80_0000, "1.0 * 1.0"),
        ...
        (0x8000_0000, 0x7F80_0000, "-0 * inf"),
        (0x7F80_0000, 0x8000_0000, "inf * -0"),
        (0x3F80_0000, 0x7FC0_0000, "1.0 * nan"),
        (0x7F80_0000, 0x7FC0_0000, "inf * nan"),
        (0x3F80_0000, 0x3F80_0001, "1.0 * (1+eps)"),
        (0x7F7F_FFFF, 0x7F7F_FFFF, "maxnormal * maxnormal"),
        (0x7F7F_FFFF, 0x4000_0000, "maxnormal * 2.0"),
