...
# Compile add.c to HEX and to ASM for this device. P2 wires the baseline
# backend (epic-cc#325), so p12f509 compiles like every other device; a
# compile failure is a real failure now.
