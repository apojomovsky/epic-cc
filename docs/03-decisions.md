...
- ADR-029: PIC18 two-vector priority interrupts (per-priority duplication, three overlay regions, GOTO stubs, per-ISR save areas; compat byte-identical), 2026-09-09
