...
fn banks_are_isolated() {
    ...
    let mut p = Pic14::new(vec![
        BSF_RP0, 0x3055, // MOVLW 0x55
        0x00A0, // MOVWF 0x20
        BCF_RP0, 0x0820, // MOVF 0x20,W
    ]);
    p.run(1000);
...
fn banksel_end_to_end() {
    ...
    let mut p = Pic14::new(vec![
        BSF_RP0, 0x3011, // MOVLW 0x11
        0x00A1, // MOVWF 0x21
        BCF_RP0, 0x3022, // MOVLW 0x22
        0x00A0, // MOVWF 0x20
    ]);
    p.run(1000);
...
fn rp0_rp1_select_bank_3() {
    ...
    let mut p = Pic14::new(vec![
        BSF_RP1, BSF_RP0, 0x3044, // MOVLW 0x44
        0x00A0, // MOVWF 0x20
    ]);
    p.run(1000);
...
fn indf_uses_irp_for_upper_half() {
    ...
    let mut p = Pic14::new(vec![
        ...
        BSF_IRP, 0x3099, // MOVLW 0x99
        0x0080, // MOVWF INDF (0x00)
        BCF_IRP, 0x30AA, // MOVLW 0xAA
        0x0080, // MOVWF INDF (0x00)
    ]);
    p.run(1000);
